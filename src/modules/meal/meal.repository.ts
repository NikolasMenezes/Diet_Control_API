...
export default class MealRepository extends BaseRepository {
  ...
  private async getFoodsFromMeal(
    meal_id: number | string,
  ...
  public async createMeal(
    { name, description, calories, user_id }: Meal,
    foods_id: number[],
  ): Promise<void> {
    try {
  ...
  public async getMealsByUserId(
    user_id: number | string,
  ): Promise<ResultSetHeader[]> {
    try {
      const query =
        'SELECT id, name, description, calories FROM meals WHERE user_id = ?';
  ...
  public async deleteFoodFromMeal(
    meal_id: number | string,
    food_id: number | string,
  ): Promise<ResultSetHeader[]> {
    return await this.execute(
      'DELETE FROM meals_foods WHERE meal_id = ? AND food_id = ?',
      meal_id,
      food_id,
    );
  }

  public async updateMealById(
    meal_id: number | string,
    meal: Partial<Meal>,
  ): Promise<ResultSetHeader[]> {
    return await this.execute(
  ...
  public async upadteMealCalories(
    meal_id: number | string,
    calories: number,
  ): Promise<ResultSetHeader[]> {
    return await this.execute(
  ...
  public async getMealCalories(
    meal_id: number | string,
  ): Promise<ResultSetHeader[]> {
    return await this.execute(
      'SELECT calories FROM meals WHERE id = ?',
      meal_id,
    );
  }
}
