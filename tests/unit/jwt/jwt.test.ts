...
describe("Validate token information", () => {
  it("Should return user's correct identity", async () => {
    ...
    const example = {
      _token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkYVdvbmdAZ21haWwuY29tIiwicGFzc3dvcmQiOiJhZG1pbiIsImlhdCI6MTcwNTM2OTcwNSwiZXhwIjozNjAwMDAwMDAwMDE3MDU0MDAwMDB9.knfmeynaZCrd3In2h7GsiVlXslZwg2ljCxGJwdbFGiU",
    };
